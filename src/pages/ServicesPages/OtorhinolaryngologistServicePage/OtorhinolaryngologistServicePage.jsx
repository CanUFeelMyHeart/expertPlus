      ...
      <ServiceSpecialistsInfoComponent>
        <div className="services_doctor_info_container">
          ...
          <h2 className="services_doctor_info_header" v>
            Следует обращать особое внимание на самочувствие маленьких детей.
          </h2>
          <h3 className="services_doctor_info_description">
            Здесь очень важно не пропустить начальную стадию заболевания и сразу
            обращаться в отделение ЛОРа, в Красноармейском районе (медицинская
            клиника «Эксперт Плюс»), для диагностики и лечения детского недуга,
            который, в основном, сопровождается:
          </h3>
          <h3 className="services_doctor_info_description">
            <ul>
              <li>
                пониженной реакцией на голосовое общение (ухудшение слуха);
              </li>
              <li>повышенной утомляемостью и сонливостью;</li>
              <li>
                обильными выделениями из носа и его постоянной заложенностью;
              </li>
              <li>постоянной припухлостью щечек и век;</li>
              <li>другими настораживающими факторами.</li>
            </ul>
          </h3>
          <h2 className="services_doctor_info_header" v>
