...
export const doctors = [
   ...
   },
   {
      ...
      doctorInfo: [
         ...
         },
         {
            header: "Курсы повышения квалификации/Переквалификация",
            description: [
               "- С-первичная специализация по  терапии (576ч.) Волгоградский государственный медицинский университет (2007г.);",
               "- Профессиональная переподготовка по программе: «Терапия» в ГОУВПО «ВолгГМУ ФАЗиСР»(576ч.)(2007г.);",
               "- Повышение квалификации по программе: «Актуальные вопросы терапии» в ГОУВПО «ВолгГМУ ФАЗиСР» (144ч.) (02.06.2015г.);",
               "- Повышение квалификации по программе: «Клиническая электрокардиография» в ГОУВПО «ВолгГМУ МЗ» (144ч.) (30.10.2017г.);",
               "- Повышение квалификации по программе: «Терапия с актуальными вопросами амбулаторной практики» в ГОУВПО «ВолгГМУ МЗ» (144ч.) (28.11.2020г.);",
               "- Повышение квалификации по программе: «Иммунизация на практике- вакцинопрофилактика» в АНО ДПО «Система дистанционного образования» (72ч.) (25.02.2021г.);",
               "- Повышение квалификации по программе: «Коморбидный пациент в амбулаторной практике» в ГОУВПО «ВолгГМУ ФАЗиСР» (144ч.) (30.12.2022г.);",
               "- Повышение квалификации по программе: «Терапия» в ООО «МрЦАМК» (144ч.) (29.06.2023г.);",
               "-  Повышение квалификации по программе: «Актуальные вопросы паллиативной медицинской помощи» в ФГБОУВО «ВолгГМУ МЗ» (144ч.) (28.06.2024г.);",
               "- Повышение квалификации по программе: «Практические аспекты применения клинических рекомендаций в общетерапевтической практике» в ФГБОУВО «ВолгГМУ МЗ» (36ч.) (24.05.2025г.)",
            ],
         },
      ],
   },
   ...
   },
   {
      id: 14,
      image: "",
      name: "Логвинов Дмитрий Александрович",
      ...
      doctorInfo: [
         ...
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
               "- ГБОУВПО «Волгоградский государственный медицинский университет» МЗ РФ (специальность: «Лечебное дело») (03.07.2015);",
               "- Интернатура по специальности: «Травматология и ортопедия» в ВолгГМУ (2016)."
            ],
         },
         {
            header: "Курсы повышения квалификации/Переквалификация",
            description: [
               "- Повышение квалификации по программе: «Травматология и ортопедия» в АНО ДПО «Центральный многопрофильный институт» (144 ч.) (29.12.2020г.);",
               "- Повышение квалификации по программе: «Травматология и ортопедия» в ФГБОУВО «ВолгГМУ МЗ» (144ч.) (26.06.2025г.)"
            ],
         },
      ],
   },
   ...
   },
   {
      ...
      doctorInfo: [
         {
            header: "Стаж работы по врачебной специальности:",
            description: ["27 лет (общий - 41 год)"],
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
      ...
      doctorInfo: [
         ...
         },
         {
            ...
            description: [
               ...
               "- Повышение квалификации по программе: «Неотложная хирургия с основами малоинвазиввных вмешательств» в ФГБОУВО «ВолгГМУ» (144ч.) (30.10.2021г.);",
               "- Повышение квалификации по программе: «Неотложная хирургия органов брюшной полости (с основами малоинвазивных технологий)» (144ч.) в ВолгГМУ (30.11.2018г.);",
               "- Повышение квалификации по программе: «Неотложная хирургия с основами малоинвазиввных вмешательств» в ФГБОУВО «ВолгГМУ» (144ч.) (30.10.2021г.)."
            ],
         },
   ...
   },
   {
      ...
      doctorInfo: [
         ...
         },
         {
            header: "Курсы повышения квалификации/Переквалификация:",
            description: [
               "- Повышение квалификации по программе: «Эндоурогия” в ФГБОУВО «ВолгГМУ» (144ч.) (28.12.2021г.);",
               "- Повышение квалификации по программе: «Амбулаторная урология» (144ч.) в ФГБОУВО «ВолгГМУ» (27.04.2024г.)."
            ],
         },
      ],
   },
   {
      ...
      doctorInfo: [
         ...
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
               "- ФГБОУВО «Майкопский государственный технологический университет» г.Майкоп (специальность: «Лечебное дело» 2019г.);",
               "- Ординатура: ФГБОУВО «Кубанский государственный медицинский университет» г.Краснодар (Специальность: «Хирургия» 2021г.);",
               "- Ординатура: ФГБОУВО «Кубанский государственный медицинский университет» г.Краснодар (Специальность: «Травматология и ортопедия» 2023г.)"
            ],
         },
      ],
   },
   ...
   },
   {
      ...
      speciality: "Врач-эндокринолог, врач ультразвуковой диагностики",
      doctorInfo: [
         {
            header: "Стаж работы по врачебной специальности:",
            description: ["9 лет, 3 года"],
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
         ...
         },
         {
            header: "Курсы повышения квалификации/Переквалификация",
            description: [
               "-  Повышение квалификации по программе: «Ожирение как мультидисциплинарная проблема» в ФГБОУВО «ВолгГМУ» (36ч.) (28.04.2017г.);",
               "-  Повышение квалификации по программе: «Актуальные вопросы диабетологии» в ФГБОУВО «ВолгГМУ» (36ч.) (06.04.2018г.);",
               "-  Профессиональная переподготовка по программе: «Ультразвуковая диагностика» в ООО «НАСТ» г.Москва  (506ч.) (14.12.2021г.)."
            ],
         },
      ],
   },
   {
      ...
      doctorInfo: [
         {
            header: "Стаж работы по врачебной специальности:",
            description: ["7 лет (общий - 30 лет)"],
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
                "- ГОУ СПО Волгоградский медицинский колледж №2 (2007г.)",
            ],
         },
         {
            header: "Курсы повышения квалификации/Переквалификация",
            description: [
               "- Повышение квалификации по программе: «Медицинский массаж» в ВолгГМУ (144ч.) (22.10.2018г.);",
               "- Повышение квалификации по программе: «Медицинский массаж» в ГАПОУ «Волгогорадский медицинский колледж» (144ч.) (29.05.2023г.)"
            ],
         },
      ],
   },
   ...
   },
   {
      ...
      doctorInfo: [
         {
            header: "Стаж работы по врачебной специальности:",
            description: ["7 лет, 6 лет"],
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
               "- Волгоградский государственный медицинский университет (Специальность: «Педиатрия» 2015г.);",
               "- Интернатура: Волгоградский государственный медицинский университет (специальность: «Хирургия» 2016г.)"
            ],
         },
         {
            header: "Курсы повышения квалификации/Переквалификация",
            description: [
               "-  Повышение квалификации по программе: «Заболевания прямой кишки и тазового дна у женщин (общемедицинские и хирургические аспекты)» в ВолгГМУ (36 ч.) (14.04.2018г.);",
               "-  Повышение квалификации по программе: «Заболевания прямой кишки и тазового дна у женщин (общемедицинские и хирургические аспекты)» в ВолгГМУ (36 ч.) (08.06.2019г.);",
               "-  Повышение квалификации по программе: «Актуальные вопросы профилактики, диагностики и лечения короновирусной инфекции КОВИД-19» в АНО ДПО «УМЦ «Тандем-Лидер» (36 ч.) (20.01.2021г.);",
               "-  Повышение квалификации по программе: «Неотложная хирургия с основами малоинвазивный вмешательств» в ВолгГМУ (144 ч.) (30.04.2022 г.);",
               "-  Профессиональная переподготовка по программе: «Ультразвуковая диагностика» в ВолгГМУ (576ч.)(29.12.2018г.);",
               "-  Повышение квалификации по программе: «Актуальные вопросы ультразвуковой диагностики в гинекологии» в ВолгГМУ (144 ч.) (28.02.2023 г.)"
            ],
         },
      ],
   },
   ...
   },
   {
      ...
      doctorInfo: [
         ...
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
               "- ФГБОУВО «Кабардино-Балкарский государственный университет им.Х.М.Бербекова» (Специальность: «Лечебное дело» (2019г.);",
               "- Ординатура по специальности: «Сердечно-сосудистая хирургия» (2021г.)"
            ],
         },
         {
            header: "Курсы повышения квалификации/Переквалификация",
            description: [
               "- Профессиональная переподготовка по специальности: «Ультразвуковая диагностика» в ФГБОУВО «К.-БГУ им.Х.М. Бербекова» (2022г.);",
               "- Профессиональная переподготовка по специальности: «Хирургия» в ООО «Непрерывное Профессиональное Образование» (2023г.)(576ч.)"
            ],
         },
      ],
   },
   ...
   },
   {
      ...
      doctorInfo: [
         {
            header: "Стаж работы по врачебной специальности:",
            description: ["19 лет (1год 6мес. - кардиолог)"],
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
   ...
   },
   {
      id: 50,
      image: "",
      name: "Хлебникова Наталия Юрьевна",
      speciality: "Врач-акушер-гинеколог, врач ультразвуковой диагностики",
      doctorInfo: [
         {
            header: "Стаж работы по врачебной специальности:",
            description: ["7 лет, 4 года"],
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
               "- ГБОУВПО «Волгоградский государственный медицинский университет» МЗ РФ, специальность: Лечебное дело (2016);",
               "- Интернатура по специальности: «Акушерство и гинекология» (2017)"
            ],
         },
         {
            header: "Курсы повышения квалификации/Переквалификация",
            description: [
               "- Повышение квалификации по программе: «Акушерство и гинекология» (144ч.) (23.06.2022г.) в  АНО ДПО «ВАМО»;",
               "- Повышение квалификации по программе: «Гинекологическая эндокринология» (36ч.) (30.06.2024г.) в  ООО «ДОФОМИН»",
               "- Профессиональная переподготовка по программе: «Ультразвуковая диагностика» в ООО «ЭКСПРОМЕД» (576ч.) (31.03.2021г.)"
            ],
         },
      ],
   },
   {
      ...
      doctorInfo: [
         ...
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
               "- ГОУВПО «Волгоградский государственный медицинский университет Федераль-ного агенства по здравоохранению и социальному разви-тию», специальность: «Лечебное дело» (2006);",
               "- Интернатура по специальности: «Терапия» (2008);",
               "- Оргинатура по специальности: «Эндокринология» (2010)"
            ],
         },
         {
            header: "Курсы повышения квалификации/Переквалификация",
            description: [
               "- повышение квалификации по программе «Терапия с актуальными вопросами эндокринологии» (144ч.) в ГБОУВПО «ВолгГМУ» (30.09.2015г.);",
               "- повышение квалификации по программе «Актуальные вопросы эндокринологии с детской эндокринологией» (144ч.) в ГБОУВПО «ВолгГМУ» (12.11.2020г.);",
               "- профессиональная переподготовка по программе: «Диетологии» в ООО «МИГ» (504ч.) (22.10.2019г.);",
               "- профессиональная переподготовка по программе: «Функциональная нормализация веса и пищевого поведения» в ООО «ИФИДиН» (508ч.) (29.12.2021г.);",
               "- повышение квалификации по программе: «Современные медицинские технологии при нормализации веса и пищевого поведения» в ООО «ИФИДиН» (145ч.) (24.03.2022г.);",
               "- повышение квалификации по программе: «Продукты питания как альтернатива лекарствам. Персонифи-цированный доказательный подход в превенции хронических заболеваний» в ООО «УОМ» (96ч.) (03.02.2023г.);",
               "- повышение квалификации по программе: «Правовые и психологические аспекты взаимодействия с пациентами» в ООО «Медицинская академия» (72ч.) (07.08.2023г.);",
               "- профессиональная переподготовка по программе: «Интегративная нутрициология» в АНО ДПО МИИН (260ч.) (08.11.2023г.);",
               "- профессиональная переподготовка по программе: «Клиническая нутрициология» в АНО ДПО МИИН (305ч.) (30.05.2024г.);"
            ],
         },
      ],
   },
   {
      ...
      speciality: "Врач-уролог, врач ультразвуковой диагностики",
      doctorInfo: [
         {
            header: "Стаж работы по врачебной специальности:",
            description: ["25 лет, 7 лет"],
         },
         {
            header: "ВУЗ, где выдан документ о первичной специализации:",
            description: [
